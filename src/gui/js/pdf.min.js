	...
	(() => {
				...
				(__unused_webpack_module, exports, __w_pdfjs_require__) => {
					...
					function getDocument(t) {
						...
						const d = t.verbosity,
							...
							k = !0 === t.pdfBug,
							F = l ? l.length : (t.length ?? Number.NaN),
							R =
						...
						c.promise
							.then(() => {
								...
								return Promise.all([t, o]).then(([t, s]) => {
									if (e.destroyed) throw new Error('Loading aborted');
					...
					PDFWorkerUtil.isSameOrigin = (t, e) => {
						let i;
						try {
							i = new URL(t);
					...
					PDFWorkerUtil.createCDNWrapper = (t) => {
					...
					class AnnotationEditor {
						...
						static initialize(t, e = null) {
							...
							AnnotationEditor._borderLineWidth =
								Number.parseFloat(i.getPropertyValue('--outline-width')) || 0;
						}
						...
						fixDims() {
							...
							s ||
								(t.width = `${((100 * Number.parseFloat(i)) / a).toFixed(2)}%`);
							this.#T ||
								n ||
								(t.height = `${((100 * Number.parseFloat(e)) / r).toFixed(2)}%`);
						}
				...
				(t, e, i) => {
					...
					e.getXfaPageViewport = function getXfaPageViewport(
						...
						const { width: s, height: n } = t.attributes.style,
							a = [0, 0, Number.parseInt(s), Number.parseInt(n)];
					...
					e.PDFDateString = class PDFDateString {
						static toDateObject(t) {
							...
							const e = r.exec(t);
							if (!e) return null;
							const i = Number.parseInt(e[1], 10);
							let s = Number.parseInt(e[2], 10);
							s = s >= 1 && s <= 12 ? s - 1 : 0;
							let n = Number.parseInt(e[3], 10);
							n = n >= 1 && n <= 31 ? n : 1;
							let a = Number.parseInt(e[4], 10);
							a = a >= 0 && a <= 23 ? a : 0;
							let o = Number.parseInt(e[5], 10);
							o = o >= 0 && o <= 59 ? o : 0;
							let l = Number.parseInt(e[6], 10);
							l = l >= 0 && l <= 59 ? l : 0;
							const h = e[7] || 'Z';
							let c = Number.parseInt(e[8], 10);
							c = c >= 0 && c <= 23 ? c : 0;
							let d = Number.parseInt(e[9], 10) || 0;
							d = d >= 0 && d <= 59 ? d : 0;
							if ('-' === h) {
								a += c;
								o += d;
					...
					e.FontFaceObject = class FontFaceObject {
						...
						getPathGenerator(t, e) {
							...
							try {
								...
								return (this.compiledGlyphs[e] = (t, e) => {});
							}
					...
					e.PDFDataTransportStream = class PDFDataTransportStream {
						...
						_onReceiveData({ begin: t, chunk: e }) {
							...
							if (void 0 === t)
								...
								const e = this._rangeReaders.some((e) => {
					...
					e.validateRangeRequestCapabilities =
						function validateRangeRequestCapabilities({
							...
							const n = { allowRangeRequests: !1, suggestedLength: void 0 },
								a = Number.parseInt(t('Content-Length'), 10);
					...
					class NetworkManager {
						...
						onStateChange(t, e) {
							...
							if (206 === a) {
								...
								i.onDone({ begin: Number.parseInt(e[1], 10), chunk: r });
							} else
							...
							function encode(e, i, s, a) {
								...
								const m = new Uint8Array([
									...
									f = (function deflateSync(t) {
										...
										try {
											const e =
													Number.parseInt(process.versions.node) >= 8
														? t
														: Buffer.from(t),
				...
				(t, e, i) => {
					...
					e.renderTextLayer = function renderTextLayer(t) {
						...
						const { container: e, viewport: i } = t,
							...
							r = Number.parseFloat(s.getPropertyValue('--scale-factor'));
						'visible' === a &&
				...
				(t, e, i) => {
					...
					class FreeTextEditor extends a.AnnotationEditor {
						...
						static initialize(t) {
							...
							this._internalPadding = Number.parseFloat(
						...
						#oi() {
							...
							if (this.isVisible) this.#gi && this.#Rt.classList.add('focused');
								...
								this.#Rt.style.zIndex =
									Number.parseInt(this.#Rt.style.zIndex) + 1e3;
							}
						}
						#ai() {
		...
		(() => {
			...
			Object.defineProperty(t, 'InvalidPDFException', {
				enumerable: !0,
				get: () => e.InvalidPDFException,
			});
			Object.defineProperty(t, 'MissingPDFException', {
				enumerable: !0,
				get: () => e.MissingPDFException,
			});
			Object.defineProperty(t, 'OPS', { enumerable: !0, get: () => e.OPS });
			Object.defineProperty(t, 'PDFDataRangeTransport', {
				enumerable: !0,
				get: () => i.PDFDataRangeTransport,
			});
			...
			Object.defineProperty(t, 'PasswordResponses', {
				enumerable: !0,
				get: () => e.PasswordResponses,
			});
			Object.defineProperty(t, 'PermissionFlag', {
				enumerable: !0,
				get: () => e.PermissionFlag,
			});
			...
			Object.defineProperty(t, 'PromiseCapability', {
				enumerable: !0,
				get: () => e.PromiseCapability,
			});
			Object.defineProperty(t, 'RenderingCancelledException', {
				enumerable: !0,
				get: () => s.RenderingCancelledException,
			});
			...
			Object.defineProperty(t, 'UnexpectedResponseException', {
				enumerable: !0,
				get: () => e.UnexpectedResponseException,
			});
			Object.defineProperty(t, 'Util', { enumerable: !0, get: () => e.Util });
			Object.defineProperty(t, 'VerbosityLevel', {
				enumerable: !0,
				get: () => e.VerbosityLevel,
			});
			Object.defineProperty(t, 'XfaLayer', {
				enumerable: !0,
				get: () => h.XfaLayer,
			});
			Object.defineProperty(t, 'build', { enumerable: !0, get: () => i.build });
			Object.defineProperty(t, 'createValidAbsoluteUrl', {
				enumerable: !0,
				get: () => e.createValidAbsoluteUrl,
			});
