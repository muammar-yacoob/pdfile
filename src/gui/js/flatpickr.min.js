...
!((e, n) => {
	...
	var t = [
		...
		o = (e, n) => (void 0 === n && (n = 2), ('000' + e).slice(-1 * n)),
		r = (e) => (!0 === e ? 1 : 0);
	function l(e, n) {
		var t;
		return function () {
	...
	var c = (e) => (e instanceof Array ? e : [e]);
	function s(e, n, t) {
	...
	var p = () => {},
		h = (e, n, t) => t.months[n ? 'shorthand' : 'longhand'][e],
		v = {
			D: p,
			F: (e, n, t) => {
	...
	function k(p, v) {
		...
		function _(e) {
			...
			void 0 !== e &&
				...
				((e) => {
					...
					var i = Number.parseFloat(a.getAttribute('min')),
						l = Number.parseFloat(a.getAttribute('max')),
						c = Number.parseFloat(a.getAttribute('step')),
						s = Number.parseInt(a.value, 10),
		...
		function O() {
			if (void 0 !== w.hourElement && void 0 !== w.minuteElement) {
				var e,
					n,
					t = (Number.parseInt(w.hourElement.value.slice(-2), 10) || 0) % 24,
					a = (Number.parseInt(w.minuteElement.value, 10) || 0) % 60,
					i =
		...
		function N(e) {
			var n = g(e),
				t = Number.parseInt(n.value) + (e.delta || 0);
			...
			if (w.isOpen && !w.config.inline) {
				var n = g(e),
					...
					a =
						...
						!t &&
						!Q(e.relatedTarget),
					i = !w.config.ignoredFocusElements.some((e) => e.contains(n));
				a &&
					i &&
					(w.config.allowInput &&
						w.setDate(
		...
		function pe(e, n) {
			var t = [];
			if (e instanceof Array) t = e.map((e) => w.parseDate(e, n));
