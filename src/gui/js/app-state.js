...
const AppState = (() => {
    ...
    return {
        ...
        setSelectedPages: (pages) => { selectedPages = pages; },
        ...
        setMergedPagesData: (data) => { mergedPagesData = data; },
        clearMergedPagesData: () => { mergedPagesData = []; },
        ...
        setCurrentPreviewPage: (page) => { currentPreviewPage = page; }
    };
})();
